...
class Render(object):
    ...
    def glDrawPolygon(self, vertexes):
        ...
        for x in range(len(vertexes)):
            ...
            max__x = v1[0] if v1[0] > max__x else max__x
            min__x = v0[0] if v0[0] < min__x else min__x
            min__x = v1[0] if v1[0] < min__x else min__x
            max__y = v0[1] if v0[1] > max__y else max__y
            max__y = v1[1] if v1[1] > max__y else max__y
            min__y = v0[1] if v0[1] < min__y else min__y
            min__y = v1[1] if v1[1] < min__y else min__y
            
            self.glLineNDC((v0[0] - 1), (v0[1] - 1), (v1[0] - 1), (v1[1] - 1))
